...
const Container = () => (
  <PageTitle name="Hey! I'm George.">
    <Paragraph>
      ...
      . I am passionate about design, <TextLink href="/travel">travel</TextLink>{' '}
      and <TextLink href="/photography">photography</TextLink>, for which I have
      ...
      <TextLink href="/blog/tough-mudder">Tough Mudder</TextLink> in May 2018. I
      also try to squeeze in as much volunteering as I can, so you may find me
      dressed as a{' '}
      ...
      <TextLink href="/travel/iceland-2018">Iceland</TextLink> 💍, and live with
      her and Tigger the cat.
    </Paragraph>
    ...
    <br />
    <Paragraph>
      This site is built in React and hosted on AWS. I use it to experiment with
      things, share stuff I&apos;ve figured out, and allow people to reach-out
      to me. So if you&apos;re interested in anything I do,{' '}
