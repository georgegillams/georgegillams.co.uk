...
const BurgerButton = props => {
  ...
  const lineClassNames1 = [getClassName('burger-button__line', 'burger-button__line__one')];
  const lineClassNames2 = [getClassName('burger-button__line', 'burger-button__line__two')];
  const lineClassNames3 = [getClassName('burger-button__line', 'burger-button__line__three')];
  if (isOpen) {
  ...
  return (
    <button type="button" aria-label="Menu" onClick={onClick} className={outerClassNames.join(' ')} {...rest}>
