  ...
  return (
    <main className={classNameFinal.join(" ")} {...rest}>
      <Section name="Hi! I'm George.">
        I&apos;m an open-source software engineer at Skyscanner, passionate about design,{" "}
        <TextLink href="/travel">travel</TextLink> and photography. When I&apos;m not
        internationally photobombing unsuspecting strangers I&apos;m based somewhere between
        ...
        <br />
        <br />
        This website is a place I built to test things out, throw out content I want to share, and
        allow people to reach-out to me. So if you're interested in anything I do,{" "}
