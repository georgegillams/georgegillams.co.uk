  ...
  return (
    <main className={classNameFinal.join(" ")} {...rest}>
      <Section name="Hi! I'm George.">
        ...
        <br />
        <br />
        I use this site to build and test things, throw out content I want to share, and allow
        people to reach-out to me. So if you're interested in anything I do,{" "}
