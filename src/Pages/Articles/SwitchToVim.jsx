...
const SwitchToVim = (props) => {
  ...
  return (
	...
	<br />
          <br />
          The next step was to install vim-mode-plus for Atom (currently my JS editor of choice). Tbh I thought my Atom setup wasn&apos;t half bad - I was barely touching the mouse and was often editing more than 1 line of code at a time - but adding in vim features made me realise that I was actually missing out on a lot of handy shortcuts. Before long I'd ditched Atom for Neovim, enabled Vim mode in my .zshrc and installed Vimium for Firefox as I wanted to use Vim everywhere.
        <br />
          <br />
