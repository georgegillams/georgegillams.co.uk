    ...
    <main className={classNameFinal.join(" ")} {...rest}>
      <Section name="Switching to Vim">
        ...
        <SubSection name="Why I did it">
          It started with the classic situation of knowing someone at work who is some sort of Vim
          Jedi. I was in awe of his workflow since I arrived and soon decided that if I could dance
        ...
        <SubSection name="Getting started">
          ...
          <SubSection name="Learning Curve">
            A lot of people told me that learning Vim was a terrible mistake simply due to the
            learning curve. A lot of bloggers deemed their productivity in the coming weeks far too
            precious to invest time in increasing their productivity long-term, but despite my
            work-load and approaching deadlines I stuck with it. I guess I spent around a week at
            half speed as I found my way around and configured all the Plugins I wanted, and maybe I
            haven't yet even got back up to full-speed, but I'm getting faster every day. I&apos;ve
            learnt a new, awesome tool which has changed my outlook on how code should be written.
            And so far I've only scratched the surface of what it is capable of. So, was it worth
            it? Hell yes!
            <br />
            <br />
