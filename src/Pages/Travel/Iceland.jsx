...
const Iceland = (props) => {
  ...
  return (
    <main className={classNameFinal.join(' ')} {...rest} >
      ...
      <br />
        <br />
      Iceland is an incredibly beautiful country, with a lot of natural wonders that you can't see anywhere else. Despite getting food-poisoning on day 1, it was an awesome
