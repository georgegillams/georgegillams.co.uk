        ...
        <Section name="My Work">
          <LlAnimatedContent>
            <SubSection name="Software Engineering Masters">
              I {afterGraduation ? 'have' : 'will soon have'} a 1st class Masters in
            ...
            <SubSection name="Work">
              ...
              Southampton, and then rejoined as a full-time graduate employee
              this summer.
            </SubSection>
          </LlAnimatedContent>
          <LlAnimatedContent>
            <Section name="Portfolio">
              ...
              <LlAnimatedContent>
                <SubSection name="Backpack Design System">
                  ...
                  squad. By combining Design and Engineering, we meet our goal
                  of providing support to other teams within the business,
                  allowing them to quickly construct quality front-end products
                  with coherence. We release{' '}
                  ...
                  mixins, Swift or Objective C code. Our transition to
                  open-source happened soon after I joined Backpack making my
                  initial placement particularly interesting.
                  <br />
                  <br />
                  <TextLink external href="https://reactjs.org/">
                    React{' '}
                  ...
                  container components to hold state and allow interaction. This
                  was time-consuming, and occasionally failed to reflect the
                  real-life use-cases of our components. As a result, I decided
                  to build a demo HOC which would allow any component to be
                  passed in and automatically construct a list of props. Each
                  prop can be edited in place through the Demo component.
                  <br />
                  <br />
                  This is still a WIP, but a proof-of-concept is available to
                  use.
                  <br />
                  <br />
              ...
              <LlAnimatedContent>
                <SubSection name="Password Character Extractor">
                  ...
                  characters from a password or memorable word. This is
                  something that LastPass cannot handle for me, so I created an
                  offline tool to help.
                  <br />
                  <br />
              ...
              <LlAnimatedContent>
                <SubSection name="React.js Academic References Component">
                  ...
                  bloggers could really do with, so I got on with implementing
                  an open-source one.
                  <br />
                  <br />
                  I started simple (Minimum Awesome Product) and hope that I /
                  the OS community can expand on this to support more
                  referencing formats.
                  <br />
                  <br />
                  <FadingLazyLoadedImage
                  ...
                  <br />
                  <br />
                  <Button href="/blog/net-neutrality">
                    See it in action →
                  </Button>
                  <br />
                  <br />
              ...
              <LlAnimatedContent>
                <SubSection name="Greasemonkey - GuruShots">
                  ...
                  is a brilliant browser extension that allows you to add
                  javascript to specific webpages when they are loaded.{' '}
                  <TextLink href="https://gurushots.com/" external>
                    GuruShots{' '}
                  </TextLink>
                  is an online platform for photographers to enter their work
                  into competitions. At a random point in each competition, each
                  user is given a free boost. It is easy to miss, however, so I
                  wrote a script to regularly check for free boosts and make
              ...
              <LlAnimatedContent>
                <SubSection name="Greasemonkey - ECS">
                  The ECS site we use at Southampton is a brilliant tool that
                  was created ugly, so I wrote a GreaseMonkey script to… well…
                  improve it.
                  <br />
                  <br />
                  <FadingLazyLoadedImage
                  ...
                  <br />
                  <Button
                    href="/api/greasemonkey/secureEcs_download"
                    hrefExternal
                  >
                    Donwload script
                  </Button>
