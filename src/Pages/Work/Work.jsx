          ...
          <Section name="Portfolio">
            ...
            <LlAnimatedContent>
              <SubSection name="Backpack Design System">
                ...
                real-life use-cases of our components. As a result, I decided to
                build a demo HOC which would allow any component to be passed in
                and automatically construct a list of props. Each prop can be
            ...
            <LlAnimatedContent>
              <SubSection name="React.js Academic References Component">
                ...
                <br />
                <br />
                I started simple (Minimum Awesome Product) and hope that I / the
                OS community can expand on this to support more referencing
                formats.
                <br />
                <br />
                <FadingLazyLoadedImage
            ...
            <LlAnimatedContent>
              <SubSection name="Greasemonkey - GuruShots">
                ...
                competitions. At a random point in each competition, each user
                is given a free boost. It is easy to miss, however, so I wrote a
                script to regularly check for free boosts and make them stand
                out on the page.
                <br />
                <br />
                <FadingLazyLoadedImage
