...
const TICKET_COST_EB_ONE_DAY = 2500; // TODO UPDATE
const TICKET_COST_R_ONE_DAY = 3500; // TODO UPDATE
const TICKET_COST_EB_TWO_DAY = 4500; // TODO UPDATE
const TICKET_COST_R_TWO_DAY = 6500; // TODO UPDATE
const APP_VERSION = '4.0.0';
const TICKET_RESERVATION_LENGTH = 5; // 5 hours
const COOKIE_NAMES = [
  'session',
  'version',
  'connect.sid',
