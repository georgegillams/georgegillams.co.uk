...
const CONFERENCE_DAY_1_START = new Date(2019, 2, 20, 1, 0, 0).getTime();
const CONFERENCE_DAY_1_END = new Date(2019, 2, 20, 23, 0, 0).getTime();
const CONFERENCE_DAY_2_START = new Date(2019, 2, 21, 1, 0, 0).getTime();
const CONFERENCE_DAY_2_END = new Date(2019, 2, 21, 23, 0, 0).getTime();
