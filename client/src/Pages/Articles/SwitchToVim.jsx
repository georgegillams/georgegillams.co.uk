    ...
    <main className={classNameFinal.join(' ')} {...rest}>
      ...
      <Section name="Switching to Vim">
        ...
        <SubSection name="Why I did it">
          ...
          myself enough time to start contributing to{' '}
        ...
        <SubSection name="Getting started">
          ...
          - an online game designed to teach you all the Vim commands. It was
          odd, because I haven&apos;t played a video game for at least 5 years,
          but something about it was strangely addictive (maybe the fact that it
          wasn&apos;t group coursework?!).
          <br />
          <br />
