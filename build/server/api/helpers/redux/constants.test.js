...
test('correctly creates constants from strings', function (done) {
  var constants = (0, _constants["default"])('MY_ACTION_NAME', 'MY_ACTION_NAME_SUCCESS', 'MY_ACTION_NAME_ERROR');
...
test('correctly creates constant names from actionDefinitions', function (done) {
  var constants = (0, _constants.inferConstantsFromActionDefinitions)(testActionDefinitions);
